            ...
            <ImageBackground source={require('../img/background.png')} style={styles.backgroundImage}>
                ...
                <View style={styles.container1}>
                    ...
                    <View style = {styles.submit}>
                        <Button color='#261491' title = 'Find The Piano Store Near You!' onPress={()=> this.fetchTodos()}/>
                        <Button color='#261491' title = 'Enter A New Location And Find The Piano Stores!' onPress={()=> this.submit()}/>
                    </View>
                </View>
